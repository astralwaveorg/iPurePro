    ...
    
    {
      ...
      buttons: [
        ...
        makeFunction({
          key: "prevCandidate",
          size: { width: buttonWidth, height: buttonHeight },
          bounds: { x: { percentage: 0 }, y: { percentage: 250/667 } },
          backgroundStyle: "systemButtonBackgroundStyle",
          text: "←",
          fontSize: 16,
          action: { prevCandidate: true },
        }),
        
        makeFunction({
          key: "nextCandidate",
          size: { width: buttonWidth, height: buttonHeight },
          bounds: { x: { percentage: 9 * (if std.type(buttonWidth) == "object" then buttonWidth.percentage else buttonWidth / 1000) }, y: { percentage: 250/667 } },
          backgroundStyle: "systemButtonBackgroundStyle",
          text: "→",
          fontSize: 16,
          action: { nextCandidate: true },
        }),
      ],
